...
public class Condition implements Predicate<Map<String,? extends Comparable>>
{
    ...
    public Condition(Feature<? extends Comparable> feature,boolean isTargetCondition)
    {
    ...
    public Condition(Feature<? extends Comparable> feature,boolean isTargetCondition, SortedMap<Comparable,Boolean> featureConditions)
    {
        this.setFeature(feature);
        this.isTargetCondition = isTargetCondition;
